...
int main(int argc, const char * argv[]) {
    ...
    char line[MAX_LEN];       // 標準入力を1行分受け付ける文字列バッファ
    int input_num;            // コマンド入力用変数(整数部)
    char input_str[MAX_LEN];  // コマンド入力用変数(文字部)
