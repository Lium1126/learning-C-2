...
/*-----------------------------------+
 プログラミング及び演習II 第9回
 問題2
 構造体irisを定義し、main関数において2つの
 変数iris1,iris2を指定の設定で初期化せよ。
 作成した構造体変数の内容を標準出力に表示せよ。
 +-----------------------------------*/
...
int main(int argc, const char * argv[]) {
    ...
    setParameter(&iris1, 6.7, 3.0, 5.2, 2.3, "Iris-virginica");   //---+
    setParameter(&iris2, 7.0, 3.2, 4.7, 1.4, "Iris-versicolor");  //---+--初期化
